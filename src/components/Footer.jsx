...
function Footer() {
  return (
    <div className='w-full h-screen flex'>
      ...
      <div className='w-1/2 h-full py-20 flex flex-col'>
      <h1 className='text-[8vw] tracking-tighter leading-none font-bold'>Presentations</h1>
      <div className='dets mt-10 '>
        <h1 className='text-2xl mb-6'>S: </h1>
        <a className='block text-2xl' href='#'>Instagram</a>
        <a className='block text-2xl' href='#'>Behance</a>
        <a className='block text-2xl' href='#'>Facebook</a>
        <a className='block text-2xl' href='#'>Linkedin</a>
      </div>
      <div className='dets mt-10 '>
        <h1 className='text-2xl mb-6'>L: </h1>
        <a className='block text-2xl' href='#'>202-1965 W 4th Ave</a>
        <a className='block text-2xl mb-6' href='#'>Vancouver, Canada</a>
        <a className='block text-2xl' href='#'>30 Chukarina St</a>
        <a className='block text-2xl' href='#'>Lviv, Ukraine</a>
      </div>
      <div className='dets mt-10 '>
        <h1 className='text-2xl mb-6'>E: </h1>
        <a className='block text-2xl' href='#'>hello@ochi.design</a>
      </div>
